...
const MakeBountyElement = async (param) => {
    ...
    if (param.isExpired && !param.areObjectivesComplete) {
        ...
        itemStatus.src = 'https://cdn.brendanprice.xyz/synergy/icons/pursuit_expired.svg';
        ...
        itemStatus.src = 'https://cdn.brendanprice.xyz/synergy/icons/pursuit_completed.svg';
    };
