...
Please keep in mind that this is not a production ready process that every user will have to experience, SSL certs must be implemented to fully circumvent this.
